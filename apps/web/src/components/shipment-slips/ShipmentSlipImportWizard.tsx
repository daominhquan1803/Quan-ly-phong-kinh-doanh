      ...
      {step === "upload" && (
        <div className="space-y-3">
          <label className="flex flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed border-gray-200 bg-card py-12 cursor-pointer hover:border-amber-500 transition-colors">
            ...
            <p className="font-medium text-ink text-sm">Chọn file Excel phiếu đi hàng</p>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-4 gap-4">
            <div className="kpi-card kpi-card--navy">
              <p className="text-sm text-muted-foreground">Phiếu tạo mới</p>
              <p className="text-2xl font-bold text-ink">{result.createdCount}</p>
            </div>
            <div className="kpi-card kpi-card--navy">
              <p className="text-sm text-muted-foreground">Phiếu cập nhật</p>
              <p className="text-2xl font-bold text-ink">{result.updatedCount}</p>
            </div>
            <div className="kpi-card kpi-card--navy">
              <p className="text-sm text-muted-foreground">Tổng số phiếu</p>
              <p className="text-2xl font-bold text-ink">{result.totalSlips}</p>
            </div>
          ...
          {result.errors.length > 0 && (
            <div className="rounded-lg border border-gray-200 bg-card p-4 text-sm">
              <p className="font-medium text-ink mb-2">Chi tiết lỗi (tối đa hiển thị 20 dòng):</p>
